...
const SDL_Color cGray = {85, 85, 85, 255};
const SDL_Color cRed_Light = {255, 85, 85, 255};
const SDL_Color cRed = {255, 0, 0, 255};
const SDL_Color cGreen_Light = {85, 255, 85, 255};
const SDL_Color cGreen = {0, 255, 0, 255};
const SDL_Color cYellow_Light = {255, 255, 85, 255};
const SDL_Color cYellow = {255, 255, 0, 255};
const SDL_Color cBlue_Light = {85, 85, 255, 255};
const SDL_Color cBlue = {0, 0, 255, 255};
const SDL_Color cMagenta_Light = {255, 85, 255, 255};
const SDL_Color cMagenta = {255, 0, 255, 255};
const SDL_Color cCyan_Light = {85, 255, 255, 255};
const SDL_Color cCyan = {0, 255, 255, 255};
const SDL_Color cWhite = {255, 255, 255, 255};

// Custom Red Shades
const SDL_Color IndigenousRed = {205, 92, 92, 255};
const SDL_Color LightCoral = {240, 128, 128, 255};
const SDL_Color Salmon = {250, 128, 144, 255};
const SDL_Color DarkSalmon = {233, 160, 122, 255};
...
const SDL_Color HotPink = {255, 20, 147, 255};
...
const SDL_Color RebeccaPurple = {102, 51, 153, 255};
const SDL_Color BlueViolet = {138, 43, 226, 255};
const SDL_Color DarkViolet = {148, 0, 221, 255};
...
const SDL_Color DarkSeaGreen = {143, 188, 139, 255};
